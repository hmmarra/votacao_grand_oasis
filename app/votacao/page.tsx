          ...
          <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                          ...
                          {config.candidatos.map((candidato: string, index: number) => {
                            ...
                            return (
                              <button
                                ...
                                disabled={loading}
                                className={`p-6 sm:p-8 rounded-xl border-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 active:scale-95 ${isSelected
                              ...
                              >
                                <div className="flex items-center justify-center gap-2">
                                  ...
                                  <span className={`text-lg sm:text-xl font-semibold ${isSelected
              ...
              <div className="xl:col-span-1 h-full">
                {config && (
                  <div className="h-full rounded-2xl border border-indigo-100 dark:border-indigo-900 bg-indigo-50 dark:bg-indigo-900/20 p-6 text-indigo-900 dark:text-indigo-100 flex flex-col">
                    <div className="text-sm font-medium mb-2">Criado por: <span className="font-semibold">Meu Condomínio</span></div>
                    {config.descricao && (
                    ...
                    <p className="mt-4 text-xs text-indigo-800 dark:text-indigo-200 mt-auto">
